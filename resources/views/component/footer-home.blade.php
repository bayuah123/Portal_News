                    ...
                    <div class="row d-flex align-items-center justify-content-between">
                        <div class="col-lg-6">
                            <div class="footer-copy-right">
                                <p>
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Tembok Berita <i class="ti-heart" aria-hidden="true"></i> by <a href="https://irhamkaraman.my.id" target="_blank">Tim Gacor</a>
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="footer-menu f-right">
                                <ul>
                                    ...
                                    <li><a href="https://irhamkaraman.my.id">Kontak</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
